                ...
                <div class="col-md mb-5">
                    <div class="border p-3">
                        <form action="/klippek" method="POST">
                            ...
                            <div class="py-2">
                                <label for="youtube" class="form-label">YouToube link:</label>
                                <input type="text" name="youutbe" id="youtube" class="form-control" value="{{old('youtube')}}">
                                @error('youtube')
                                    <p class="text-danger">{{$message}}</p>
                                @enderror
                            </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    ...
                                    <td>{{substr($row->hossz,3,5)}} év</td>
                                    <td><a href="{{$row->youtube}}">{{$row->youtube}}</a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
